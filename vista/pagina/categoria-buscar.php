...
<div class="container">
	<ul class="full-box list-unstyled page-tabs">
		...
		<li>
			<a href="<?php echo urlServidor; ?>categoria-listar/"><i class="fa-solid fa-clipboard-list fa-fw"></i> &nbsp; Listar de categoria</a>
		</li>
		<li>
...
<div class="container">
	<div class="px-3">
		<div class="card mb-4">
			...
			echo $categoria_controlador->listar_categoria_controlador($pagina[0], 5, $pagina[0], $_SESSION['busqueda_categoria']);
			}
			?>
			</div>
		</div>
